...
$(function()
{
  ...
  const strTitle2 = "あなたへのおすすめは、<a href=""https://promo.kadokawa.co.jp/macro-nutrient-calculator/">「マクロ栄養計算機」</a>";
  const strText2 = "食事管理の継続ができているあなたは、アプリの補助が必要無いかもしれません。しかし、1日の消費カロリーを知っていないと、効果的なダイエットにはつながりません。WEB版マクロ栄養計算機を利用して、自身の基礎代謝を測定しましょう。それに合わせて食事管理をすれば確実に体重は落ちていくでしょう。";

  const strTitle3 = "あなたにおすすめのアプリは「カロミル」";
  const strText3 = "基礎代謝を理解し、継続ができているあなたは、1日の摂取カロリーを把握すればダイエットに確実に成功します。カロミルを利用して、1日の摂取カロリーを徹底管理してみましょう。食事への理解があなたのダイエットを成功に導きます。";
  ...
  const strText5 = "自分の食事をしっかり管理しているようですね、さらにそれをWEB版マクロ栄養計算機を利用して自身の基礎代謝を把握してみましょう。それに沿った食事をすることであなたの食事管理は完成します。そして継続が苦手なあなたは、SmartDietを利用して毎日体重を測り、記録してみましょう。非常に高いモチベーションUP効果が見込めます。";
  ...
  const strText7 = "継続ができているので、あとは自身の摂取カロリーと消費カロリーを理解するだけです。WEB版マクロ栄養計算機で自身の基礎代謝を測り、それに合わせてカロミルで食事による摂取カロリーを管理しましょう。これでダイエット成功間違い無しですね";

  const strTitle8 = "あなたにおすすめのアプリは「カロミル」";
  const strText8 = "消費カロリーと摂取カロリーが把握、継続ができていないようですね、この3つはダイエットにおいて最も重要です。カロミルは1日の摂取カロリーを理解、管理できます。これに加えて自身の基礎代謝がわかるサイト　を利用し、それに合わせてカロリーを管理しましょう。カロミルには体重をグラフ化し、推移を見る機能もあるので、継続へのモチベーションUPの効果も期待できます。毎日体重を測って記録しましょう。これでダイエット成功間違い無しですね！";

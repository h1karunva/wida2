...
$(function()
{
  ...
  const strText2 = "食事管理の継続ができているあなたは、アプリの補助が必要無いかもしれません。しかし、1日の消費カロリーを知っていないと、効果的なダイエットにはつながりません。WEB版マクロ栄養計算機を利用して、自身の基礎代謝を測定しましょう。それに合わせて食事管理をすれば確実に体重は落ちていくでしょう。下記のURLをコピーしてマクロ栄養計算サイトを使用してみてください　https://promo.kadokawa.co.jp/macro-nutrient-calculator/";
